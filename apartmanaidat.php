...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','1*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ocak','2019');goster('ocak2019<?php echo $icerik['kul_id']; ?>');gizle('gizleocak2019<?php echo $icerik['kul_id']; ?>');">
...
?> 
 ...
 <td data-yil="2019" data-ay="1"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','1*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ocak','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','2*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Şubat','2019');goster('subat2019<?php echo $icerik['kul_id']; ?>');gizle('gizlesubat2019<?php echo $icerik['kul_id']; ?>');">
...
?> 
	...
	<?php }else{?>
 <td data-yil="2019" data-ay="2"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','2*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Şubat','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','3*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mart','2019');goster('mart2019<?php echo $icerik['kul_id']; ?>');gizle('gizlemart2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="3"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','3*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mart','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','4*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Nisan','2019');goster('nisan2019<?php echo $icerik['kul_id']; ?>');gizle('gizlenisan2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="4"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','4*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Nisan','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','5*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mayıs','2019');goster('mayis2019<?php echo $icerik['kul_id']; ?>');gizle('gizlemayis2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="5"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','5*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mayıs','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','6*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Haziran','2019');goster('haziran2019<?php echo $icerik['kul_id']; ?>');gizle('gizlehaziran2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="6"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','6*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Haziran','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','7*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Temmuz','2019');goster('temmuz2019<?php echo $icerik['kul_id']; ?>');gizle('gizletemmuz2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="7"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','7*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Temmuz','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','8*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ağustos','2019');goster('agustos2019<?php echo $icerik['kul_id']; ?>');gizle('gizleagustos2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="8"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','8*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ağustos','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','9*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Eylül','2019');goster('eylul2019<?php echo $icerik['kul_id']; ?>');gizle('gizleeylul2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="9"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','9*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Eylül','2018')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','10*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ekim','2019');goster('ekim2019<?php echo $icerik['kul_id']; ?>');gizle('gizleekim2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="10"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','10*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ekim','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','11*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Kasım','2019');goster('kasim2019<?php echo $icerik['kul_id']; ?>');gizle('gizlekasim2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="11"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','11*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Kasım','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','12*2019','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Aralık','2019');goster('aralik2019<?php echo $icerik['kul_id']; ?>');gizle('gizlearalik2019<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2019" data-ay="12"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','12*2019','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Aralık','2019')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','1*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ocak','2020');goster('ocak2020<?php echo $icerik['kul_id']; ?>');gizle('gizleocak2020<?php echo $icerik['kul_id']; ?>');">
...
?> 
 ...
 <td data-yil="2020" data-ay="1"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','1*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ocak','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','2*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Subat','2020');goster('subat2020<?php echo $icerik['kul_id']; ?>');gizle('gizlesubat2020<?php echo $icerik['kul_id']; ?>');">
...
?> 
	...
	<?php }else{?>
 <td data-yil="2020" data-ay="2"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','2*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Şubat','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','3*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mart','2020');goster('mart2020<?php echo $icerik['kul_id']; ?>');gizle('gizlemart2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="3"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','3*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mart','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','4*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Nisan','2020');goster('nisan2020<?php echo $icerik['kul_id']; ?>');gizle('gizlenisan2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="4"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','4*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Nisan','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','5*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mayıs','2020');goster('mayis2020<?php echo $icerik['kul_id']; ?>');gizle('gizlemayis2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="5"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','5*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mayıs','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','6*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Haziran','2020');goster('haziran2020<?php echo $icerik['kul_id']; ?>');gizle('gizlehaziran2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="6"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','6*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Haziran','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','7*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Temmuz','2020');goster('temmuz2020<?php echo $icerik['kul_id']; ?>');gizle('gizletemmuz2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="7"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','7*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Temmuz','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','8*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ağustos','2020');goster('agustos2020<?php echo $icerik['kul_id']; ?>');gizle('gizleagustos2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="8"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','8*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ağustos','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','9*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Eylül','2020');goster('eylul2020<?php echo $icerik['kul_id']; ?>');gizle('gizleeylul2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="9"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','9*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Eylül','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','10*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ekim','2020');goster('ekim2020<?php echo $icerik['kul_id']; ?>');gizle('gizleekim2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="10"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','10*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ekim','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','11*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Kasım','2020');goster('kasim2020<?php echo $icerik['kul_id']; ?>');gizle('gizlekasim2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="11"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','11*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Kasım','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','12*2020','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Aralık','2020');goster('aralik2020<?php echo $icerik['kul_id']; ?>');gizle('gizlearalik2020<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2020" data-ay="12"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','12*2020','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Aralık','2020')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','1*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ocak','2021');goster('ocak2021<?php echo $icerik['kul_id']; ?>');gizle('gizleocak2021<?php echo $icerik['kul_id']; ?>');">
...
?> 
 ...
 <td data-yil="2021" data-ay="1"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','1*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ocak','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','2*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Subat','2021');goster('subat2021<?php echo $icerik['kul_id']; ?>');gizle('gizlesubat2021<?php echo $icerik['kul_id']; ?>');">
...
?> 
	...
	<?php }else{?>
 <td data-yil="2021" data-ay="2"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','2*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Şubat','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','3*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mart','2021');goster('mart2021<?php echo $icerik['kul_id']; ?>');gizle('gizlemart2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="3"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','3*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mart','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','4*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Nisan','2021');goster('nisan2021<?php echo $icerik['kul_id']; ?>');gizle('gizlenisan2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="4"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','4*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Nisan','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','5*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mayıs','2021');goster('mayis2021<?php echo $icerik['kul_id']; ?>');gizle('gizlemayis2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="5"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','5*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Mayıs','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','6*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Haziran','2021');goster('haziran2021<?php echo $icerik['kul_id']; ?>');gizle('gizlehaziran2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="6"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','6*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Haziran','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','7*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Temmuz','2021');goster('temmuz2021<?php echo $icerik['kul_id']; ?>');gizle('gizletemmuz2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="7"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','7*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Temmuz','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','8*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Temmuz','2021');goster('agustos2021<?php echo $icerik['kul_id']; ?>');gizle('gizleagustos2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="8"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','8*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ağustos','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','9*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Eylül','2021');goster('eylul2021<?php echo $icerik['kul_id']; ?>');gizle('gizleeylul2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="9"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','9*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Eylül','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','10*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ekim','2021');goster('ekim2021<?php echo $icerik['kul_id']; ?>');gizle('gizleekim2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="10"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','10*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Ekim','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','11*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Kasım','2021');goster('kasim2021<?php echo $icerik['kul_id']; ?>');gizle('gizlekasim2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="11"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','11*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Kasım','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<td onclick="sil('<?php echo $kullanicicek['kul_id'] ?>','<?php echo $sonuc2['daire_id']; ?>','12*2021','<?php echo $toplam['apt_id']; ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Aralık','2021');goster('aralik2021<?php echo $icerik['kul_id']; ?>');gizle('gizlearalik2021<?php echo $icerik['kul_id']; ?>');">
...
?> </div>
	<?php }else{?>
 <td data-yil="2021" data-ay="12"><a onclick="odemeyap('<?php echo $kullanicicek['kul_id'] ?>','3','<?php echo $sonuc2['daire_id']; ?>','<?php echo $toplam["aidatucret"]; ?>','<?php echo date('Y-m-d'); ?>','1','<?php echo date('Y-m-d H:i:s'); ?>','12*2021','<?php echo $toplam["apt_id"]; ?>','<?php echo date('d.m.Y H.i.s'); ?>','<?php echo $icerik['kul_id']; ?>','<?php $toplam['apt_isim'] ?>','<?php echo $sonuc2['daire_no']; ?>','<?php echo $icerik['kul_isim']; ?>','Aralık','2021')"><i class="fa fa-close" aria-hidden="true"></i> </a></td>
<?php } ?>
...
<script type="text/javascript"> 
		function sil(kullanıcı_id,daire_id,tarih,apt_id,apt_isim,daire_no,donemayi,yil) {
  ...
  swalWithBootstrapButtons.fire({
    title: 'AİDAT KALDIR',
    text: "<?php echo $toplam["apt_isim"]; ?> Apartmanı "+"D-" + daire_no + " "+ donemayi+"/"+yil + ' aidat ödenmedi olarak değiştirilsin mi ?',
    icon: 'warning',
    ...
    if (result.value) {
                 ...
                 var islem="sor";
        $.ajax({	
        url: "https://www.takiptr.com/ajax_aidatkaldir.php",
        data:{deger1:daire_id,deger2:tarih,deger3:apt_id},
        type: "post",
  ...
  function odemeyap(deger1,deger2,deger3,deger4,deger5,deger6,deger7,deger8,deger9,deger10,deger11,apt_isim,daire_no,ad,donemayi,yil){
		   const swalWithBootstrapButtons = Swal.mixin({
  customClass: {
...
swalWithBootstrapButtons.fire({
  title: 'AİDAT',
  text: "<?php echo $toplam["apt_isim"]; ?> Apartmanı "+"D-"+daire_no + " " + donemayi+"/"+yil + ' aidat ödendi olarak değiştirilsin mi ?',
  icon: 'warning',
  showCancelButton: true,
  confirmButtonText: 'Evet',
  cancelButtonText: 'Vazgeç',
